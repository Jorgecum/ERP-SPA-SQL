...
const SEED_DB = {
    users: [
        { id: 1, username: 'admin', password: '123', role: 'Super Admin', name: 'Carlos Delgado', status: 'Activo' },
        { id: 2, username: 'vendedor', password: '123', role: 'Vendedor', name: 'Juan Perez', status: 'Activo' }
    ],
    exchangeRates: [
    ...
    entities: [
        { id: 1, type: 'CLIENTE', docType: 'RUC', document: '20123456789', name: 'Constructora ABC S.A.C.', address: 'Av. Industrial 123', phone: '987654321', email: 'contacto@abc.com', status: 'Activo' },
        { id: 2, type: 'PROVEEDOR', docType: 'RUC', document: '10765432101', name: 'Acero Global Corp', address: 'Calle Las Flores 456', phone: '999888777', email: 'ventas@acero.com', status: 'Activo' },
        { id: 3, type: 'EMPRESA', docType: 'RUC', document: '20555555555', name: 'Delgado EIRL', address: 'Zona Industrial 999', phone: '900000000', email: 'info@delgado.com', status: 'Activo' },
        { id: 4, type: 'CLIENTE', docType: 'DNI', document: '12345678', name: 'Juan Perez', address: 'Calle Falsa 123', phone: '999111222', email: 'juan@perez.com', status: 'Activo' }
    ],
    sales: [],
    proformas: [],
    installments: [],
...
const api = {
    async login(username, password) {
        ...
        if (user.status === 'Inactivo') throw new Error('Usuario desactivado. Contacte al administrador.');
        return user;
    },
...
const state = {
    ...
    caches: { products: [], clients: [], entities: [] },
    liveTimeFormatted: '',
